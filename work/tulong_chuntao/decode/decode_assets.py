# -*- coding: utf-8 -*-
"""P1 — decode 魂·屠龙-春桃 verified assets."""
...
ACQ = _REPO / "work" / "tulong_chuntao" / "acquire" / "verified_root"
OUT = _REPO / "work" / "tulong_chuntao" / "decode"
CFREZ = _REPO / "CFRezManager" / "bin" / "Debug" / "net8.0-windows7.0" / "CFRezManager.exe"

PV_LTB = ACQ / "Models" / "PLAYERVIEW" / "PV-Kukri_Beast.LTB"
PV_DTX = ACQ / "ModelTextures" / "PLAYERVIEW" / "PV-Kukri_Beast_spring.DTX"
MAPS = [
    ACQ / "ModelTextures" / "SpecularMap" / "Kukri_Beast_Spring_S.PNG",
    ACQ / "ModelTextures" / "NormalMap" / "Kukri_Beast_Spring_N.PNG",
    ACQ / "ModelTextures" / "AlphaMap" / "Kukri_Beast_Spring_A.PNG",
]
CFG = ACQ / "ModelTextures" / "Shader" / "WeaponShader" / "Kukri_Beast_Spring.CFG"
...
def main() -> int:
    ...
    (OUT / "PV-Kukri_Beast.body.bin").write_bytes(body)
    ...
    skin_out = OUT / "cf_skin_kukri_spring.json"
    proc = subprocess.run(
    ...
    png = OUT / "PV-Kukri_Beast_spring.png"
    res["image"].save(png)
