...
OUT_PNG = r"D:\project\cf_to_csgo\work\tulong_chuntao\texture\up\kukri_spring_baked.png"
...
img = bpy.data.images.new('baked_spring', 2048, 2048, alpha=False)
...
m.blend_type = 'ADD'
m.inputs['Fac'].default_value = 0.9
nt.links.new(t1.outputs['Color'], m.inputs[1])
nt.links.new(pw.outputs[0], m.inputs[2])
