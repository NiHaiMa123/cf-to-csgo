# -*- coding: utf-8 -*-
"""P1 — decode 毛瑟-天秤座 (M1896_Libra) verified assets."""
...
ACQ = _REPO / "work" / "mauser_libra" / "acquire" / "verified_root"
OUT = _REPO / "work" / "mauser_libra" / "decode"
CFREZ = _REPO / "CFRezManager" / "bin" / "Debug" / "net8.0-windows7.0" / "CFRezManager.exe"

PV_LTB = ACQ / "Models" / "PLAYERVIEW" / "PV-M1896_Libra.LTB"
PV_DTX = ACQ / "ModelTextures" / "PLAYERVIEW" / "PV-M1896_Libra.DTX"
MAPS = [
    ACQ / "ModelTextures" / "SpecularMap" / "M1896_Libra_S.TGA",
    ACQ / "ModelTextures" / "NormalMap" / "M1896_Libra_N.TGA",
    ACQ / "ModelTextures" / "AlphaMap" / "M1896_Libra_alpha.TGA",
    ACQ / "ModelTextures" / "EnvCubeMap" / "LobbyCube.DDS",
]
CFG = ACQ / "ModelTextures" / "Shader" / "WeaponShader" / "M1896_Libra.CFG"
...
def main() -> int:
    ...
    (OUT / "PV-M1896_Libra.body.bin").write_bytes(body)
    ...
    skin_out = OUT / "cf_skin_m1896_libra.json"
    proc = subprocess.run(
