...
CFG = VERIFIED / "ModelTextures/Shader/WeaponShader/M1896_Libra.CFG"
DIFFUSE = DECODE / "PV-M1896_Libra.png"
SPECULAR = MAPS / "M1896_Libra_S.TGA"
NORMAL = MAPS / "M1896_Libra_N.TGA"
ALPHA = MAPS / "M1896_Libra_alpha.TGA"
CUBEMAP = MAPS / "LobbyCube.DDS"


def b1() -> dict:
    ir = material_ir.new_ir("cf_mauser_libra", shader_family="unclassified")
    ...
    out = MV2 / "ir" / "cf_mauser_libra.material_ir.json"
