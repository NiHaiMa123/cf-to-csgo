...
DIFFUSE = DECODE / "PV-M1896_Libra.png"
...
def a1() -> dict:
    ...
    assets = [
        {"role": "mesh_ltb", "path": VERIFIED / "Models/PLAYERVIEW/PV-M1896_Libra.LTB",
         "logical_path": "Models/PLAYERVIEW/PV-M1896_Libra.LTB"},
        {"role": "diffuse_dtx", "path": VERIFIED / "ModelTextures/PLAYERVIEW/PV-M1896_Libra.DTX",
         "logical_path": "ModelTextures/PLAYERVIEW/PV-M1896_Libra.DTX"},
        {"role": "cfg", "path": VERIFIED / "ModelTextures/Shader/WeaponShader/M1896_Libra.CFG",
         "logical_path": "ModelTextures/Shader/WeaponShader/M1896_Libra.CFG"},
        {"role": "specular", "path": VERIFIED / "ModelTextures/SpecularMap/M1896_Libra_S.TGA",
         "logical_path": "ModelTextures/SpecularMap/M1896_Libra_S.TGA"},
        {"role": "normal", "path": VERIFIED / "ModelTextures/NormalMap/M1896_Libra_N.TGA",
         "logical_path": "ModelTextures/NormalMap/M1896_Libra_N.TGA"},
        {"role": "alpha", "path": VERIFIED / "ModelTextures/AlphaMap/M1896_Libra_alpha.TGA",
         "logical_path": "ModelTextures/AlphaMap/M1896_Libra_alpha.TGA"},
        ...
        {"role": "mesh_ltb_bl", "path": VERIFIED / "Models/PLAYERVIEW/PV-M1896_Libra_BL.LTB",
         "logical_path": "Models/PLAYERVIEW/PV-M1896_Libra_BL.LTB", "required": False},
        {"role": "mesh_ltb_gr", "path": VERIFIED / "Models/PLAYERVIEW/PV-M1896_Libra_GR.LTB",
         "logical_path": "Models/PLAYERVIEW/PV-M1896_Libra_GR.LTB", "required": False},
    ]
    manifest = input_manifest.build_input_manifest(
        weapon="M1896_Libra", material_id="cf_mauser_libra",
