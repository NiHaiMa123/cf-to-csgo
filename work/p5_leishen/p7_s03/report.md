...
Addon: `p_cf_leishen_m4a4_p6` (world files added; viewmodel untouched)
Dropped internal name `weapons\w_rif_m4a1_dropped.mdl`, bones `10`.
Held internal name `weapons\w_rif_m4a1.mdl`, bones `94`.
