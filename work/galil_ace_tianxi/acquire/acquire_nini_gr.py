# -*- coding: utf-8 -*-
"""Acquire 妮妮-保卫者 (Nini GR) first-person arm assets."""
...
MANIFEST = OUT / "nini_gr_acquisition.json"

WANTED = [
    "Models/PLAYERVIEW/ArmModel/Arm_Nini_GR.LTB",
    "ModelTextures/PLAYERVIEW/FVIEW_HAND_Nini_GR.DTX",
    "ModelTextures/PLAYERVIEW/FVIEW_ARM_Nini_GR.DTX",
    "ModelTextures/NormalMap/FVIEW_HAND_Nini_GR_N.PNG",
    "ModelTextures/NormalMap/FVIEW_ARM_Nini_GR_N.PNG",
    "ModelTextures/SpecularMap/FVIEW_HAND_Nini_GR_S.PNG",
    "ModelTextures/SpecularMap/FVIEW_ARM_Nini_GR_S.PNG",
    "ModelTextures/AlphaMap/FVIEW_HAND_Nini_GR_A.PNG",
    "ModelTextures/AlphaMap/FVIEW_ARM_Nini_GR_A.PNG",
    "ModelTextures/Shader/AdvancedShader/Arm_Nini_GR_Piece0.CFG",
    "ModelTextures/Shader/AdvancedShader/Arm_Nini_GR_Piece1.CFG",
]
...
def main() -> int:
    ...
    for index_path in indexes:
        ...
        for e in entries:
            ...
            k = key(fp)
            ku = k.upper()
            if "NINI" in ku and ("ARM" in ku or "FVIEW" in ku or "HAND" in ku):
                extras.append(fp)
            if k in wanted and is_complete_directory_md5(e.get("md5")):
                found[k] = (index_path, e)
    manifest = {
        "generated_at_utc": datetime.now(timezone.utc).isoformat(),
        "character": "Nini GR / 妮妮-保卫者",
        "files": [],
        "missing": [],
        "nini_related": sorted(set(extras)),
    }
    ...
    print("related count", len(manifest["nini_related"]))
    for p in manifest["nini_related"]:
