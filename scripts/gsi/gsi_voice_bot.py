...
class GSIServer(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        # Write payload to file so we know GSI is working
        with open(os.path.join(log_dir(), "gsi_is_working.log"), "a", encoding="utf-8") as f:
            f.write("RECEIVED GSI PAYLOAD!\n")
